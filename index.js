...
const PHRASES = [
  'hello my name is antek, lol',
  'antek are funny lalalalalalalallalala',
...
const veryLongString = repeatStringNumTimes(repeatStringNumTimes('zostaĹeĹ zptoszkowany!!1 ',100),1500)
    ...
    const createCredentialDefaultArgs = {
      ...
      // Relying Party (a.k.a. - Service):
        ...
        user: {
          ...
          name: 'antek@nerdzioch.pl',
          displayName: 'Nerdzioch Antek'
        },
...
/**
 * Kopiuje ~4 miliony znakĂłw do schowka  - added by @9fm
 */
